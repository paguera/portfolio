    ...
    <div className="space-y-8">
        ...
        {articles.map((article) => {
          return (
            ...
            >
              {article.image_url && (
                <div
                  className="aspect-video w-full overflow-hidden border-b-2 border-border-subtle group-hover:border-secondary relative cursor-zoom-in bg-[#070b14]"
                  onClick={() => {
      ...
      {lightboxImage && (
        ...
        >
          ...
          <div
            className="relative max-w-6xl max-h-[85vh] w-full flex items-center justify-center overflow-auto p-2 bg-[#090e1a] border-2 border-white/20 rounded-xl shadow-2xl"
            onClick={(e) => e.stopPropagation()}
          >
            <img
